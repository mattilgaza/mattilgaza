export const FORSIDE_HEADER_QUERY = `*[_type == "forside" && slug.current == "header"][0]{title, subtitle}`;
export const INTRO_QUERY = `*[_type == "forside" && slug.current == "introduksjon"][0]{title, body}`;
